                    ...
                    <div className="hidden flex-col md:flex">
                        <div className="flex-1 space-y-4 p-8 pt-6">
                            <div className="flex items-center justify-between space-y-2">
                                <h2 className="text-3xl font-bold tracking-tight">Examify Dashboard</h2>
                            ...
                            <Tabs defaultValue="overview" className="space-y-4">
                                <TabsList>
                                    ...
                                    <TabsTrigger value="personnel-management">Personnel Management</TabsTrigger>
                                </TabsList>
                                    ...
                                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                                        ...
                                        <Card className="col-span-3">
                                            <CardHeader>
                                                ...
                                                <CardDescription>
                                                    Latest updates on exam schedules and changes.
                                                </CardDescription>
                                            </CardHeader>
                                            <CardContent>
                                                <RecentSales />
                                ...
                                <TabsContent value="exam-schedule" className="space-y-4">
                                    {/* Add components related to Exam Schedule */}
                                </TabsContent>
                                <TabsContent value="room-management" className="space-y-4">
                                    {/* Add components related to Room Management */}
                                </TabsContent>
                                <TabsContent value="personnel-management" className="space-y-4">
                                    {/* Add components related to Personnel Management */}
                                </TabsContent>
                            </Tabs>
                        </div>
                    </div>
